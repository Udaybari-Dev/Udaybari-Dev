...
Passionate about building **scalable data pipelines, cloud-native architectures, and real-time data systems**.  
I work on end-to-end data engineering solutions — from ingestion to transformation to analytics.
...
**Also working with:** ETL/ELT Pipelines · Apache Spark · Databricks · Prefect · OpenSearch · Delta Lake · Data Lakehouse Architecture
...
**Azure:** ADLS Gen2 · Azure Data Factory · Azure Synapse · Databricks on Azure  
...
- 🔄 Advanced Spark optimizations & streaming with Spark Structured Streaming
- 🏗️ Data Lakehouse patterns (Delta Lake, Iceberg)
- 🤖 ML pipeline integration with data engineering workflows
- 📐 Data architecture & system design at scale

---

🔥 _"Build pipelines that scale, not just code that works."_
